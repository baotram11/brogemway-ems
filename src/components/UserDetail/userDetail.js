                ...
                >
                    ...
                    <Col>
                        <Tab.Content>
                                        ...
                                        <div className='card-body media align-items-center'>
                                            ...
                                            <div className='media-body ml-4 mt-10'>
                                                ...
                                                <div className='text-light small mt-1'>
                                                    Cho phép định dạng JPG, GIF
                                                    hoặc PNG. Kích thước tối đa
                                                    là 800K
                                                </div>
                                                <CreateAvatar
                                                    getData={getData}
                            ...
                            <Tab.Pane eventKey='#account-orders'>
                                This is for list of orders
                            </Tab.Pane>
