									...
									<div className='col-12'>
										<div className='select-categories'>
											...
											<div className='nice-select' tabIndex='0'>
												<span className='current'>Table</span>
												<ul className='list'>
													<li data-value='' className='option focus'>
														Type
													</li>
								...
								<div className='range_item'>
									<span className='irs js-irs-0'>
										<span className='irs'>
											...
											<span className='irs-min' style={{ visibility: 'visible' }}>
												tk. 0
											</span>
											...
											<span
												className='irs-to'
												style={{ visibility: 'visible', left: '40.3704%' }}>
												tk. 500
											</span>
											<span
												className='irs-single'
												style={{ visibility: 'visible', left: '11.1111%' }}>
												tk. 0 - tk. 500
											</span>
										</span>
										...
										<span
											className='irs-bar'
											style={{ width: '47.2222%', left: '2.77778%' }}></span>
										<span
							...
							<div className='col-lg-12'>
								<div className='count-job mb-35'>
									...
									<div className='select-cat'>
										...
										<div className='nice-select' tabIndex='0'>
											<span className='current'>Sofa</span>
											<ul className='list'>
												<li data-value='' className='option selected'>
													Sofa
												</li>
