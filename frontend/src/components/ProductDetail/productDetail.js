					...
					<div className='row s_product_inner'>
						...
						<div className='col-lg-5 offset-lg-1'>
							<div className='s_product_text'>
								...
								{/* {product.Description} */}
								<p>
									Gi&agrave;y thể thao đế thấp Tread Slick m&agrave;u trắng / vải cotton
									nhiều m&agrave;u của Alexander McQueen c&oacute; phần cổ tương phản, mũi
									gi&agrave;y tr&ograve;n, đ&iacute;nh ren ph&iacute;a trước, kh&oacute;a
									k&eacute;o ở g&oacute;t v&agrave; đế cao su chunky.
									<br /> C&oacute; nguồn gốc từ Savile Row, Alexander McQueen kết hợp di sản
									may đo của Anh với tinh thần nổi loạn r&otilde; rệt. Dưới sự quản
									l&yacute; của Sarah Burton - người đ&atilde; tạo ra tầm nh&igrave;n
									l&atilde;ng mạn của ri&ecirc;ng m&igrave;nh trong khi vẫn duy tr&igrave;
									một g&oacute;c cạnh khi&ecirc;u kh&iacute;ch - ng&ocirc;i nh&agrave; tiếp
									tục g&acirc;y ấn tượng với bộ trang phục kh&ocirc;ng lỗi, những bản in
									r&ugrave;ng rợn v&agrave; d&ograve;ng gi&agrave;y thể thao tuy&ecirc;n bố
									đặc trưng.
								</p>{' '}
								<p>Đặc điểm:</p>{' '}
								<ul>
									{' '}
									<li>G&oacute;t: 5,5 cm;</li> <li>Nền: 4 cm;</li>{' '}
									<li>
										B&ecirc;n ngo&agrave;i: 100% cotton, L&oacute;t: 100% da, Đế: 100% cao
										su
									</li>{' '}
					...
					<div className='tab-content' id='myTabContent'>
						<div className='tab-pane fade' id='home' role='tabpanel' aria-labelledby='home-tab'>
							<p>
								...
								Reading at the age of 15, where she went to secretarial school and then into
								an insurance office. After moving to London and then Hampton, she eventually
								married her next door neighbour from Reading, John Cook. He was an officer in
								the Merchant Navy and after he left the sea in 1956, they bought a pub for a
								year before John took a job in Southern Rhodesia with a motor company. Beryl
								bought their young son a box of watercolours, and when showing him how to use
								it, she decided that she herself quite enjoyed painting. John subsequently
								bought her a child’s painting set for her birthday and it was with this that
								she produced her first significant work, a half-length portrait of a
								dark-skinned lady with a vacant expression and large drooping breasts. It was
								aptly named ‘Hangover’ by Beryl’s husband and
							</p>
							<p>
								It is often frustrating to attempt to plan meals that are designed for one.
								Despite this fact, we are seeing more and more recipe books and Internet
								websites that are dedicated to the act of cooking for one. Divorce and the
								death of spouses or grown children leaving for college are all reasons that
								someone accustomed to cooking for more than one would suddenly need to learn
								how to adjust all the cooking practices utilized before into a streamlined
